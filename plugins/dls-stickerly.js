...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  if (!text) {
    ...
    const interactiveMessage = proto.Message.InteractiveMessage.create({
      header: { title: 'DENJI BOT - STICKERLY', subtitle: 'Busca y descarga stickers', hasMediaAttachment: false },
  ...
  try {
    ...
    const interactiveMessage = proto.Message.InteractiveMessage.create({
      header: { title: 'DENJI BOT - STICKERLY', subtitle: 'Selecciona un paquete', hasMediaAttachment: false },
